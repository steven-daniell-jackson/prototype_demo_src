...
@Component({
  ...
  templateUrl: "./bootstrap-landing-page.component.html",
  styleUrls: ["./bootstrap-landing-page.component.scss"]
})
export class BootstrapLandingPageComponent implements OnInit {
